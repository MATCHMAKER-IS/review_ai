 ...
 */
export const REVIEW_PROMPT_VERSION = "2.5.0";
...
const INSTRUCTIONS = [
  ...
  "- before / after は、実際に文字が異なる最小限の範囲にしてください。",
  "  ①と②で共通している前後の部分は含めないでください。",
  "  ただし、変更範囲の直後に句点「。」があり、それも置き換わって",
  "  いる場合は句点まで含めます。",
  "  例: ①『19:30の誤りとのこと、承知いたしました。』と",
  "      ②『19:30の誤りとのこと、承知しました(^^♪』では、",
  "      共通の『19:30の誤りとのこと、承知』は含めず、",
  "      変わった部分だけを対応させます。",
  "      → before『いたしました。』／ after『しました(^^♪』",
  ...
  JSON.stringify(
    {
      diffs: [
        { before: "いたしました。", after: "しました(^^♪", kind: "文末表現" },
        { before: "共通部分を除いた変更箇所のみ", after: "変更後", kind: "敬語 など" },
      ],
